...
class ExpertTest {
    ...
    void setUp() {
        ...
        int[] idTrainers = new int[]{0,1};
        String[] namesTrainers = new String[]{"Ash", "Aurora"};
        try {
            game.initGame(trainers, pokemons, items, attacks, false, idTrainers, namesTrainers);
    ...
    void shouldUseItemWhenPokemonHasCriticalHealth() {
        try {
            ...
            Pokemon pokemon = game.getTeams().get(0).getTrainer().getPokemons().get(0);
